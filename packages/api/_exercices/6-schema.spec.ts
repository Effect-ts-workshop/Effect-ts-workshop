...
└─ ["strength"]
  ...
  it.skip("[OPTIONAL] can indicate refinement errors", () => {
...
└─ ["age"]
  ...
  it.skip("[OPTIONAL] should format errors as array", () => {
  ...
  it.skip("[OPTIONAL] can easily create arbitrary data for your tests", () => {
  ...
  it.skip("[OPTIONAL] can create your own schema", () => {
  ...
  it.skip("[OPTIONAL] can enhance clarity in error messages", () => {
  ...
  it.skip("[OPTIONAL] can provide paths to invalid data", () => {
