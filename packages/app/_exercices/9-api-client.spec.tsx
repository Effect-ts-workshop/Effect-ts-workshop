...
describe("HttpApiClient", () => {
  it.skip("calls GET /items and returns the typed list", async () => {
    const program = TODO
  ...
  it.skip("calls GET /items/:itemId and returns an Option<InventoryItem>", async () => {
    const program = TODO
  ...
  it.skip("composes multiple calls with Effect.all", async () => {
